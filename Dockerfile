...
# =============================================================================
# Stage 1: Build Go backend (Key-Auth Gateway + Admin API)
# Stage 2: Final minimal image
#
# The built-in frontend and all payment/purchase surfaces are stripped; the
# binary deploys as a pure Gateway + Admin API. Build WITHOUT -tags embed.
# =============================================================================
...
# Build the binary (BuildType=release for CI builds). No embedded frontend.
